...
function renderSitecorePlaceholders({placeholders, children, name, placeholderIndex}: SFCPlaceholderProps) {
...
export class PrivatePlaceholder extends React.Component<any, {}> {
    ...
    renderSitecore() {
        let self = this;
        return (
            <div className="placeholder__container" dangerouslySetInnerHTML={{ __html: this.props.placeholder}}></div>
        );
    }
